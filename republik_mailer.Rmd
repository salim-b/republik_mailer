...
knit_readme <- function()
{
  ...
  if ( fs::file_exists("README.gfm") ) fs::file_delete("README.gfm")
}
```
                                        ...
                                        auth_cookie = config$auth_cookie)
{
  ...
  fetch_html <- function()
  {
    rlang::with_handlers(httr::GET(url = glue::glue("https://www.republik.ch/format/{format}"),
...
mail_alles_was_recht_ist <- function(latest_one_only = TRUE)
{
  spread_new_articles(format = "alles-was-recht-ist",
                      ...
                      image_url = "https://gitlab.com/salim-b/republik_mailer/raw/master/images/justitia-560.jpg",
                      latest_one_only = latest_one_only)
}
```
...
```{r, mail-am-gericht}
mail_am_gericht <- function(only_run_on_days = 3,
                            latest_one_only = TRUE)
{
  spread_new_articles(format = "am-gericht",
                      ...
                      image_url = paste0("https://cdn.republik.space/s3/republik-assets/github/republik/format-am-gericht/images/",
                                         "ab46b8bfb396500f80893b333aece0419aa536ac.png?resize=560x"),
                      latest_one_only = latest_one_only,
...
mail_briefing_aus_bern <- function(only_run_on_days = 4,
                                   latest_one_only = TRUE,
                                   randomize_image = FALSE)
{
  if ( randomize_image )
  {
    ...
    images <- tibble::tibble(
      url = c("https://gitlab.com/salim-b/republik_mailer/raw/master/images/storm-brewing-over-the-parliament-560.jpg",
              "https://gitlab.com/salim-b/republik_mailer/raw/master/images/bundesplatz-560.jpg",
              "https://gitlab.com/salim-b/republik_mailer/raw/master/images/bundeshaus-560.jpg",
              "https://gitlab.com/salim-b/republik_mailer/raw/master/images/bundeshaus2-560.jpg",
              "https://gitlab.com/salim-b/republik_mailer/raw/master/images/water-fountain-560.jpg",
              "https://gitlab.com/salim-b/republik_mailer/raw/master/images/museumsnacht-bundeplatz-stereographic-560.jpg",
              "https://gitlab.com/salim-b/republik_mailer/raw/master/images/bern-bundesplatz-560.jpg"),
      credits = c(
        paste0(
  ...
  {
    image_url <- paste0("https://cdn.repub.ch/s3/republik-assets/github/republik/magazine/images/",
                        "175fcbe4fcb26c0cdcb31b62d6dae351345c16be.png?resize=560x360")
    image_text <- "Symbolbild"
  }
...
mail_preis_der_republik <- function(only_run_on_days = 4,
                                    latest_one_only = TRUE)
{
  spread_new_articles(format = "preis-der-republik",
                      ...
                      image_url = paste0("https://cdn.repub.ch/s3/republik-assets/github/republik/format-preis-der-republik/images/",
                                         "bfd51622c2e607f006779492f542bca83942a56a.jpeg?resize=560x"),
                      latest_one_only = latest_one_only,
                      only_run_on_days = only_run_on_days)
}
```
