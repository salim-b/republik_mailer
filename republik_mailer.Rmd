...
This is a simple wrapper function around the CLI tool [minify](https://github.com/tdewolff/minify/tree/master/cmd/minify). Please ensure, it's in the system's `$PATH` before using it.

```{r, minify-html}
minify_html <- function(html,
                        command = "/home/salim/.executables_links/minify")
{
  filepath %>%
    shQuote(type = "sh") %>%
